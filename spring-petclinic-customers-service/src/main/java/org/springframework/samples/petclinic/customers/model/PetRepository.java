...
import io.quarkus.data.jpa.repository.Query;
import io.quarkus.data.repository.query.Param;

/**
 * Repository class for <code>Pet</code> domain objects All method names are compliant with Quarkus Data naming
