 ...
 */
package io.quarkus.samples.petclinic.vets.model;

import io.quarkus.data.jpa.repository.JpaRepository;

/**
 * Repository class for <code>Vet</code> domain objects All method names are compliant with Quarkus Data naming
